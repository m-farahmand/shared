...
namespace CesarBmx.Shared.Persistence.Extensions
{
    ...
    {
        public static void UpdateCollection<TEntity>(this DbContext dbContext, List<TEntity> currentEntities, List<TEntity> newEntities) where TEntity : class, IAuditableEntity
        {
